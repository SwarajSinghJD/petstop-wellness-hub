  ...
  component: () => (
    <>
      <section className="mx-auto max-w-3xl px-6 py-28 text-center">
        ...
        <a href="tel:+18005550199" className="mt-10 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground hover:opacity-90 transition-opacity">
